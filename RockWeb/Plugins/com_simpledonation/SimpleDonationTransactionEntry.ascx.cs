...
TransactionAccountDetails: [
  ...
  },
  {
    ...
    [BooleanField( "Cover Fees Checked", "Determines whether the 'cover fees' checkbox is checked by default", false, "", 35, IsRequired = true )]
    [BooleanField( "Cover Fees Visible", "Determines whether the 'cover fees' checkbox will be displayed", true, "", 36, IsRequired = true )]
        ...
        private PaymentSchedule GetSchedule()
        {
            ...
            if ( GetAttributeValue( "AllowScheduled" ).AsBoolean() )
            {
                ...
                if ( schedule.TransactionFrequencyValue.Guid == _firstFifteenthGuid )
                {
                    ...
                    schedule.StartDate = today.Day >= 15
