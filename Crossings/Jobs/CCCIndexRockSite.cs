...
namespace Crossings.Jobs
{
    /// <summary>
    /// This job indexes the specified ;site.
    /// </summary>
    [DisplayName( "Crossings Index Rock Site" )]
    [Description( "This job Uses the Rock indexSite as template" )]
    ...
    public class CCCIndexRockSite : IJob
    {
