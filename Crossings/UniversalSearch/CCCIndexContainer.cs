...
namespace  Crossings.UniversalSearch
{
    ...
    /// </summary>
    public class CCCIndexContainer : Container<IndexComponent, IComponentData>
    {
        /// <summary>
        /// Singleton instance
        /// </summary>
        private static readonly Lazy<CCCIndexContainer> instance =
            new Lazy<CCCIndexContainer>( () => new CCCIndexContainer() );
        ...
        /// The instance.
        /// </value>
        public static CCCIndexContainer Instance
        {
            get {
                if ( instance != null )
                {
        ...
        {
            foreach ( var indexType in CCCIndexContainer.Instance.Components )
            {
